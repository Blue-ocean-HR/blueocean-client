...
{favorited ?          <svg className="ml-1 mr-1 self-end w-6 h-6 text-yellow-400" xmlns="http://www.w3.org/2000/svg" fill="yellow" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
