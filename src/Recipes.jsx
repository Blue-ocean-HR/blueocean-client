...
const Recipes = ({recipes, setRecipes, ingredients, getUserFavorites, toggleFavorite}) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-accent text-4xl font-bold">RECIPES</h1>
    ...
    <div class="relative w-full lg:w-1/2 md:w-3/4">
    ...
    <button onClick={handleSearch} type="submit" class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-black bg-secondary rounded-lg border border-secondary hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><svg class="mr-2 -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>Search</button>
</form>
      <div>
      ...
      <div className="choose-ingredient mb-8 mt-3">
